...
export function SiteFooter() {
  return (
    <footer className="pt-32 pb-12 px-6 md:px-10 border-t border-brand-navy/10 bg-brand-white text-brand-navy">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-16 md:gap-24 mb-24 max-w-7xl mx-auto">
        <div>
          ...
          <Link
            to="/agendamento"
            className="inline-flex items-center gap-3 text-[10px] uppercase tracking-[0.2em] px-6 py-4 border border-brand-navy/15 rounded-full hover:bg-brand-navy hover:text-brand-white transition-all duration-500"
          >
            Reservar consulta
          ...
          <div className="flex gap-3 mt-10">
            {socials.map(({ label, href, Icon }) => (
              <a
                ...
                aria-label={label}
                className="size-11 rounded-full border border-brand-navy/15 flex items-center justify-center hover:bg-brand-navy hover:text-brand-white transition-all"
              >
